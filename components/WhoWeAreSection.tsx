        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection className="order-2 lg:order-1">
            ...
            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
              <p>
                <strong>TOUCHEEGLOW</strong> is your premier destination for luxury skincare, both wholesale and retail. Based in Canada, we offer a curated range of high-quality products at competitive prices for resellers and individual customers.
              </p>
              <p>
          ...
          <AnimatedSection className="order-1 lg:order-2 relative" delay={200}>
            <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl relative group">
              <Image
                src="/skincare-aesthetic.jpg"
                alt="TOUCHEEGLOW Skincare"
                fill
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl max-w-xs hidden md:block animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Luxury Skincare</p>
                </div>
              </div>
            </div>
          </AnimatedSection>
