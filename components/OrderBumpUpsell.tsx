    ...
    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border-2 border-amber-200">
      ...
      <div className="space-y-4">
        {products.map((product) => (
          <div
            key={product.id}
            className={`bg-white rounded-lg p-4 border-2 transition-all cursor-pointer ${product.selected
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-lg font-bold text-blue-700">CA${product.price.toFixed(2)}</span>
                  {product.originalPrice && (
                    <>
                      <span className="text-sm text-gray-400 line-through">CA${product.originalPrice.toFixed(2)}</span>
              ...
              <div className={`w-8 h-8 flex items-center justify-center rounded-full border-2 transition-colors ${product.selected
