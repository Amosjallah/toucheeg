...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero title="Shopping Cart" backgroundImage="/skincare-aesthetic.jpg" />
                ...
                <div className="lg:col-span-2 space-y-6">
                  <div className="bg-white rounded-xl shadow-sm p-6 overflow-hidden">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      {savings > 0 && (
                        <span className="text-blue-700 font-semibold">You save CA${savings.toFixed(2)}</span>
                      )}
                    </div>
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      {appliedCoupon && (
                        <div className="flex justify-between text-blue-700">
                          ...
                          <span className="font-semibold">-CA${couponDiscount.toFixed(2)}</span>
                        </div>
                      )}

                      <div className="flex justify-between text-gray-700">
                        <span>Shipping</span>
                        <span className="font-semibold">{shipping === 0 ? 'FREE' : `CA${shipping.toFixed(2)}`}</span>
                      </div>
