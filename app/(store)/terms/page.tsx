        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              By accessing and using this website (TOUCHEEGLOW), you accept and agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use our website or services.
            </p>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All content on this website, including text, graphics, logos, images, videos, and software, is the property of TOUCHEEGLOW or its content suppliers and is protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              To the fullest extent permitted by law, TOUCHEEGLOW shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from:
            </p>
            <ul className="space-y-2 text-gray-600 mb-6">
              <li className="flex items-start gap-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              You agree to indemnify and hold harmless TOUCHEEGLOW, its affiliates, officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the website, violation of these terms, or infringement of any third-party rights.
            </p>
          </section>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">TOUCHEEGLOW<br />Canada</p>
                  </div>
                </div>
              </div>
            </div>
