        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us at <a href="mailto:toucheeglow@gmail.com" className="text-blue-700 font-medium hover:underline">toucheeglow@gmail.com</a> or through your account settings. We will respond within 30 days.
            </p>
          </section>
