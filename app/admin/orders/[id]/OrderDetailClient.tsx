      ...
      <div className="print-section hidden print:block bg-white p-8">
        <div className="border-2 border-gray-800 p-6">
          ...
          <div className="flex justify-between items-start border-b-2 border-gray-800 pb-4 mb-4">
            <div>
              <h1 className="text-2xl font-bold">TOUCHEEGLOW</h1>
              ...
              <tbody>
                {order?.order_items?.map((item: any) => (
                  <tr key={item.id} className="border-b border-gray-200">
                    ...
                    <td className="py-2 px-2 text-right">CA$ {item.unit_price?.toFixed(2)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="flex justify-between mb-6">
            ...
            <div className="text-right">
              <p>Subtotal: CA$ {order?.subtotal?.toFixed(2)}</p>
              <p>Shipping: CA$ {order?.shipping_total?.toFixed(2)}</p>
              <p className="font-bold text-lg border-t border-gray-400 pt-1 mt-1">Total: CA$ {order?.total?.toFixed(2)}</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                {order.order_items?.map((item: any) => (
                  <div key={item.id} className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="font-semibold text-gray-900 mb-1">CA$ {item.unit_price?.toFixed(2)}</p>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 space-y-3">
                ...
                <div className="flex justify-between text-gray-700">
                  <span>Shipping</span>
                  <span>CA$ {order.shipping_total?.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-gray-700">
                  <span>Tax</span>
                  <span>CA$ {order.tax_total?.toFixed(2)}</span>
                </div>
                {order.discount_total > 0 && (
                  <div className="flex justify-between text-blue-700 font-semibold">
                    <span>Discount</span>
                    <span>-CA$ {order.discount_total?.toFixed(2)}</span>
                  </div>
                )}
