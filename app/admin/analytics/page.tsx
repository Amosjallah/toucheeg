      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">CA${metrics.revenue.toLocaleString()}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">CA${metrics.aov.toFixed(2)}</p>
          </div>
          ...
          <div style={{ width: '100%', height: 350 }}>
            <ResponsiveContainer>
              <AreaChart data={salesData.length > 0 ? salesData : [{ date: 'No Data', sales: 0 }]}>
                ...
                <Tooltip />
                <Legend />
                <Area type="monotone" dataKey="sales" stroke="#10b981" fillOpacity={1} fill="url(#colorSales)" name="Sales (CA$)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
                ...
                <tbody className="divide-y divide-gray-100">
                  {topProducts.map((product, index) => (
                    <tr key={index}>
                      ...
                      <td className="py-3 text-right text-sm font-semibold text-blue-600">CA${product.revenue.toLocaleString()}</td>
                    </tr>
                  ))}
